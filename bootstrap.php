...
elseif(NSM_ENV == 'mobile') {
  ...
  $env_global_vars = array(
    ...
    $upload_preferences = array(
        1 => array(                                             // ID of upload destination
            'name'        => 'Uploads',                         // Display name in control panel
            'server_path' => '/var/www/thegoodlab.com/content/uploads/Images', // Server path to upload directory
            'url'         => 'http://thegoodlab.com/content/uploads/Images'              // URL of upload directory
        )
        ,2 => array(                                             // ID of upload destination
            'name'        => 'Screenshots',                         // Display name in control panel
            'server_path' => '/var/www/thegoodlab.com/content/uploads/Screenshots', // Server path to upload directory
            'url'         => 'http://thegoodlab.com/content/uploads/Screenshots'              // URL of upload directory
        )
    );
}
