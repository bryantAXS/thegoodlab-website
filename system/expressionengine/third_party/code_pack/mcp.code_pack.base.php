...
class Code_pack_cp_base extends Module_builder_bridge
{
    var $theme_path	= '';
    var $theme_url	= '';
	...
	function __construct( $switch = TRUE )
    {
        ...
        parent::Module_builder_bridge('code_pack');
		...
		$this->theme_path	= PATH_THEMES . 'solspace_themes/code_pack/';
        $this->theme_url	= rtrim( ee()->config->item('theme_folder_url'), '/' ) . '/' . 'solspace_themes/code_pack/';
    ...
    {
        require_once PATH_THIRD . 'code_pack/upd.code_pack.php';
    	
    	$U = new Code_pack_updater();
    	return $U->install();
    }
