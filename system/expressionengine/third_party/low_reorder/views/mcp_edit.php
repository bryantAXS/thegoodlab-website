<form method="post" action="<?=$base_url?>&amp;method=save_set" id="reorder-settings">
	...
	<table class="mainTable" cellspacing="0" cellpadding="0">
		...
		<tbody>
			<tr class="<?=low_zebra()?>">
				<td><label for="set_label">* <?=lang('set_label')?></label></td>
	...
	<table class="mainTable" cellspacing="0" cellpadding="0">
		...
		<tbody>
			...
			<!-- List of channels -->
			<tr class="<?=low_zebra()?>">
				<td class="multi"><span class="label">* <?=lang('channels')?></span></td>
				<td id="channel-settings"><?=$select_channel?></td>
			</tr>

			<!-- List of statuses -->
			<tr class="<?=low_zebra()?>">
				<td class="multi"><label for="settings-status">* <?=lang('statuses')?></label></td>
