...
class Low_reorder_mcp extends Low_reorder_base {
	...
	*/
	public function index()
	{
		...
		{
			$permissions = $this->EE->low_reorder_set_model->get_permissions(low_array_decode($set['permissions']));
	...
	*/
	public function edit()
	{
		...
		$set['permissions'] = low_array_decode($set['permissions']);
	...
	*/
	public function save_set()
	{
		...
		$sql_data['parameters']  = low_array_encode($sql_data['parameters']);
		$sql_data['permissions'] = low_array_encode($sql_data['permissions']);
