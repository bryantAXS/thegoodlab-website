	...
	$('#page-ui').NestedSortable(
		{
			...
			onChange: function(serialized) {
				$.post(EE.BASE+"&C=addons_modules&M=show_module_cp&module=structure&method=ajax_reorder&site_id="+structure_settings.site_id, serialized[0].hash+"&XID="+structure_settings.xid);
			},
			autoScroll: true,
