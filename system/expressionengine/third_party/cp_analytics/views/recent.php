...
<p><?=$this->EE->lang->line('analytics_viewing_profile')?> <a href="<?=$this->EE->cp->masked_url('https://www.google.com/analytics/reporting/?id='.$profile['id'])?>" target="_blank"><?=$profile['title']?></a></p>
<?php endif; ?>