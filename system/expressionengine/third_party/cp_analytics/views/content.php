...
<table class="analytics-panel analytics-reports" cellspacing="0">
	...
	<?php endforeach?>
	<tr>
		<td class="analytics-report-link bottom-left bottom-right cap" colspan="2"><a href="<?=$this->EE->cp->masked_url('https://www.google.com/analytics/reporting/content?id='.$profile['id'])?>" target="_blank"><?=$this->EE->lang->line('analytics_more')?></a></td>
	</tr>
</table>
